...
export class SetupDockerContainer extends AsyncTask {
  ...
  public async onStart() {
    ...
    logger.info(`INIT: enabled (proper signal handling and zombie process reaping)`);
    ...
    this.container = await docker.createContainer({
      ...
      HostConfig: {
        ...
        Mounts: mounts,
        // PERFORMANCE: Enable init process for proper signal handling and zombie process reaping
        Init: true
      },
      NetworkingConfig: {
        EndpointsConfig: {
